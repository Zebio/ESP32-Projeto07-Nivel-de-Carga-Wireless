...
phpbb.addAjaxCallback('kd.themeconfig_save' , function(kd) { 
	kd.success?phpbb.alert(kd.MESSAGE_TITLE,kd.MESSAGE_TEXT):phpbb.alert(kd.MESSAGE_TITLE,kd.MESSAGE_TEXT)
});
